...
export default function Work() {
  const WorkData = [
    {
      title: "Web Solution it",
      institution: "Dinajpur , Bangladesh",
      session: "10/May/2025 - Present  ",
      description:
        "Web Developer.",
    },
    ...
    >
      ...
      >
        ...
        <p className="text-sm max-w-3xl mx-auto leading-relaxed my-6 text-des">
          My work journey reflects continuous exploration, where challenges became opportunities and every project fueled my passion for growth.
        </p>
      </motion.header>
